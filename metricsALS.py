...
class metrics(object):
  def __init__(self, region, date, gtx, pho, seg, ρg, ρv):
  ...
  def ch(self):
    ...
    print('Calculating canopy heights', end='\r')
  ...
  def cv(self):
    ...
    print('Calculating canopy cover', end='\r')
  ...
  def rh(self):
    ...
    print('Calculating RH metrics', end='\r')
  ...
  def lai(self):
    ...
    print('Calculating LAI profiles', end='\r')
    self.ds = xr.Dataset()
...
class atl(object):
  ...
  def __init__(self, region, date, gtx, ls=100.):
    print('Reading real photons', end='\r')
    self.p = params(region)
...
class sim(object):
  ...
  def __init__(self, region, date, gtx):
    print('Reading simulated photons', end='\r')
    self.p = params(region)
...
class comparison(object):
  def __init__(self, region, date, gtx, ρg, ρv):
    print('Getting %s %s %s metrics' % (region, date, gtx), end='\r')
    self.region = region
    self.date = date
    self.gtx = gtx
    self.ρg = ρg
  ...
  def getSimBins(self):
    ...
    print('Binning simulated photons into segments', end='\r')
  ...
  def getSimSegs(self):
    ...
    print('Calculating simulated segment stats', end='\r')
  ...
  def getPairs(self):
    ...
    print('Pairing real and simulated data', end='\r')
  ...
  def getMetrics(self):
    ...
    print('Getting canopy metrics', end='\r')
    real = metrics(self.region, self.date, self.gtx, self.real.pho, self.real.seg, self.ρg, self.ρv)
